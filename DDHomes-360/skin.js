...
// Pano2VR 5.2.2/15983
// Filename: SO_DD_Homes.ggsk
// Generated Fri Oct 27 11:48:31 2017
...
function pano2vrSkin(player,base) {
	...
	ggSkinVars['PhotoBaseballCheck'] = false;
	ggSkinVars['PhotoDAMCheck'] = false;
	ggSkinVars['Menu_Vis'] = false;
	var me=this;
	var flag=false;
	this.player=player;
	...
	this.addSkin=function() {
		...
		this._photo_baseball=document.createElement('div');
		this._photo_baseball.ggId="Photo_baseball";
		this._photo_baseball.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._photo_baseball.ggVisible=true;
		this._photo_baseball.className='ggskin ggskin_container ';
		this._photo_baseball.ggType='container';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 371px;';
		hs+='position : absolute;';
		...
		hs+='width : 100px;';
		hs+='pointer-events:none;';
		this._photo_baseball.setAttribute('style',hs);
		this._photo_baseball.style[domTransform + 'Origin']='50% 50%';
		me._photo_baseball.ggIsActive=function() {
			return false;
		}
		me._photo_baseball.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._photo_baseball.ggUpdatePosition=function (useTransition) {
		}
		this.divSkin.appendChild(this._photo_baseball);
		...
		hs+='white-space: nowrap;';
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: CiAgPC9saW5lYXJHcmFkaWVudD4KPC9kZWZzPgogIDxzdHlsZSB0eXBlPSd0ZXh0L2Nzcyc;';
		...
		this._image_2.ggLeft=-79;
		this._image_2.ggTop=-91;
		...
		this._photo_dam=document.createElement('div');
		this._photo_dam.ggId="Photo_DAM";
		this._photo_dam.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._photo_dam.ggVisible=true;
		this._photo_dam.className='ggskin ggskin_container ';
		this._photo_dam.ggType='container';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 371px;';
		hs+='position : absolute;';
		...
		hs+='width : 100px;';
		hs+='pointer-events:none;';
		this._photo_dam.setAttribute('style',hs);
		this._photo_dam.style[domTransform + 'Origin']='50% 50%';
		me._photo_dam.ggIsActive=function() {
			return false;
		}
		me._photo_dam.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._photo_dam.ggUpdatePosition=function (useTransition) {
		}
		this.divSkin.appendChild(this._photo_dam);
		...
		this._menu_group=document.createElement('div');
		this._menu_group.ggId="Menu_group";
		this._menu_group.ggLeft=35;
		this._menu_group.ggTop=309;
		this._menu_group.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menu_group.ggVisible=true;
		this._menu_group.className='ggskin ggskin_container ';
		this._menu_group.ggType='container';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 35px;';
		hs+='position : absolute;';
		...
		hs+='width : 100px;';
		hs+='pointer-events:none;';
		this._menu_group.setAttribute('style',hs);
		this._menu_group.style[domTransform + 'Origin']='50% 50%';
		me._menu_group.ggIsActive=function() {
			return false;
		}
		me._menu_group.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		me._menu_group.ggCurrentLogicStatePosition = -1;
		this._menu_group.ggUpdateConditionTimer=function () {
			var newLogicStatePosition;
			if (
				(ggSkinVars['Menu_Vis'] == true)
			)
			{
			...
			if (me._menu_group.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._menu_group.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._menu_group.style[domTransition]='left 500ms ease 0ms, top 500ms ease 0ms';
				if (me._menu_group.ggCurrentLogicStatePosition == 0) {
					me._menu_group.ggLeft=-235;
					me._menu_group.ggTop=308;
					me._menu_group.ggUpdatePosition(true);
				}
				else {
					me._menu_group.ggLeft=35;
					me._menu_group.ggTop=309;
					me._menu_group.ggUpdatePosition(true);
				}
			}
		}
		this._menu_group.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		this._svg_1.ggLeft=-164;
		this._svg_1.ggTop=-550;
		...
		this._svg_2.onmouseup=function (e) {
			ggSkinVars['Menu_Vis'] = !ggSkinVars['Menu_Vis'];
		}
		this._svg_2.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._svg_2);
		this._menuitem_9=document.createElement('div');
		this._menuitem_9__text=document.createElement('div');
		this._menuitem_9.className='ggskin ggskin_textdiv';
		this._menuitem_9.ggTextDiv=this._menuitem_9__text;
		this._menuitem_9.ggId="MenuItem_9";
		this._menuitem_9.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_9.ggVisible=true;
		this._menuitem_9.className='ggskin ggskin_text ';
		this._menuitem_9.ggType='text';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 105px;';
		hs+='position : absolute;';
		...
		hs+='width : 118px;';
		hs+='pointer-events:auto;';
		this._menuitem_9.setAttribute('style',hs);
		this._menuitem_9.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_9.style[domTransform]=parameterToTransform(this._menuitem_9.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_9__text.setAttribute('style',hs);
		this._menuitem_9__text.innerHTML="East Bathroom";
		this._menuitem_9.appendChild(this._menuitem_9__text);
		me._menuitem_9.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_9.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_9.onclick=function (e) {
			me.player.openNext("{node1}","");
		}
		this._menuitem_9.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_9);
		this._menuitem_8=document.createElement('div');
		this._menuitem_8__text=document.createElement('div');
		this._menuitem_8.className='ggskin ggskin_textdiv';
		this._menuitem_8.ggTextDiv=this._menuitem_8__text;
		this._menuitem_8.ggId="MenuItem_8";
		this._menuitem_8.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_8.ggVisible=true;
		this._menuitem_8.className='ggskin ggskin_text ';
		this._menuitem_8.ggType='text';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 105px;';
		hs+='position : absolute;';
		...
		hs+='width : 118px;';
		hs+='pointer-events:auto;';
		this._menuitem_8.setAttribute('style',hs);
		this._menuitem_8.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_8.style[domTransform]=parameterToTransform(this._menuitem_8.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_8__text.setAttribute('style',hs);
		this._menuitem_8__text.innerHTML="West Bathroom";
		this._menuitem_8.appendChild(this._menuitem_8__text);
		me._menuitem_8.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_8.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_8.onclick=function (e) {
			me.player.openNext("{node6}","");
		}
		this._menuitem_8.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_8);
		this._menuitem_7=document.createElement('div');
		this._menuitem_7__text=document.createElement('div');
		this._menuitem_7.className='ggskin ggskin_textdiv';
		this._menuitem_7.ggTextDiv=this._menuitem_7__text;
		this._menuitem_7.ggId="MenuItem_7";
		this._menuitem_7.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_7.ggVisible=true;
		this._menuitem_7.className='ggskin ggskin_text ';
		this._menuitem_7.ggType='text';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 105px;';
		hs+='position : absolute;';
		...
		hs+='width : 118px;';
		hs+='pointer-events:auto;';
		this._menuitem_7.setAttribute('style',hs);
		this._menuitem_7.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_7.style[domTransform]=parameterToTransform(this._menuitem_7.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_7__text.setAttribute('style',hs);
		this._menuitem_7__text.innerHTML="East Bedroom";
		this._menuitem_7.appendChild(this._menuitem_7__text);
		me._menuitem_7.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_7.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_7.onclick=function (e) {
			me.player.openNext("{node2}","");
		}
		this._menuitem_7.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_7);
		this._menuitem_6=document.createElement('div');
		this._menuitem_6__text=document.createElement('div');
		this._menuitem_6.className='ggskin ggskin_textdiv';
		this._menuitem_6.ggTextDiv=this._menuitem_6__text;
		this._menuitem_6.ggId="MenuItem_6";
		this._menuitem_6.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_6.ggVisible=true;
		this._menuitem_6.className='ggskin ggskin_text ';
		this._menuitem_6.ggType='text';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 104px;';
		hs+='position : absolute;';
		...
		hs+='width : 118px;';
		hs+='pointer-events:auto;';
		this._menuitem_6.setAttribute('style',hs);
		this._menuitem_6.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_6.style[domTransform]=parameterToTransform(this._menuitem_6.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_6__text.setAttribute('style',hs);
		this._menuitem_6__text.innerHTML="West Bedroom";
		this._menuitem_6.appendChild(this._menuitem_6__text);
		me._menuitem_6.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_6.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_6.onclick=function (e) {
			me.player.openNext("{node7}","");
		}
		this._menuitem_6.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_6);
		this._menuitem_5=document.createElement('div');
		this._menuitem_5__text=document.createElement('div');
		this._menuitem_5.className='ggskin ggskin_textdiv';
		this._menuitem_5.ggTextDiv=this._menuitem_5__text;
		this._menuitem_5.ggId="MenuItem_5";
		this._menuitem_5.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_5.ggVisible=true;
		this._menuitem_5.className='ggskin ggskin_text ';
		this._menuitem_5.ggType='text';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 105px;';
		hs+='position : absolute;';
		...
		hs+='width : 118px;';
		hs+='pointer-events:auto;';
		this._menuitem_5.setAttribute('style',hs);
		this._menuitem_5.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_5.style[domTransform]=parameterToTransform(this._menuitem_5.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_5__text.setAttribute('style',hs);
		this._menuitem_5__text.innerHTML="Hallway";
		this._menuitem_5.appendChild(this._menuitem_5__text);
		me._menuitem_5.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_5.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_5.onclick=function (e) {
			me.player.openNext("{node4}","");
		}
		this._menuitem_5.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_5);
		this._menuitem_4=document.createElement('div');
		this._menuitem_4__text=document.createElement('div');
		this._menuitem_4.className='ggskin ggskin_textdiv';
		this._menuitem_4.ggTextDiv=this._menuitem_4__text;
		this._menuitem_4.ggId="MenuItem_4";
		this._menuitem_4.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_4.ggVisible=true;
		this._menuitem_4.className='ggskin ggskin_text ';
		this._menuitem_4.ggType='text';
		hs ='';
		hs+='height : 25px;';
		hs+='left : 89px;';
		hs+='position : absolute;';
		...
		hs+='width : 151px;';
		hs+='pointer-events:auto;';
		this._menuitem_4.setAttribute('style',hs);
		this._menuitem_4.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_4.style[domTransform]=parameterToTransform(this._menuitem_4.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_4__text.setAttribute('style',hs);
		this._menuitem_4__text.innerHTML="Dining Room";
		this._menuitem_4.appendChild(this._menuitem_4__text);
		me._menuitem_4.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_4.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_4.onclick=function (e) {
			me.player.openNext("{node5}","-51.45\/-7.13\/79");
		}
		this._menuitem_4.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_4);
		this._menuitem_3=document.createElement('div');
		this._menuitem_3__text=document.createElement('div');
		this._menuitem_3.className='ggskin ggskin_textdiv';
		this._menuitem_3.ggTextDiv=this._menuitem_3__text;
		this._menuitem_3.ggId="MenuItem_3";
		this._menuitem_3.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_3.ggVisible=true;
		this._menuitem_3.className='ggskin ggskin_text ';
		this._menuitem_3.ggType='text';
		hs ='';
		hs+='height : 20px;';
		hs+='left : 105px;';
		hs+='position : absolute;';
		...
		hs+='width : 118px;';
		hs+='pointer-events:auto;';
		this._menuitem_3.setAttribute('style',hs);
		this._menuitem_3.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_3.style[domTransform]=parameterToTransform(this._menuitem_3.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_3__text.setAttribute('style',hs);
		this._menuitem_3__text.innerHTML="Kitchen";
		this._menuitem_3.appendChild(this._menuitem_3__text);
		me._menuitem_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_3.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_3.onclick=function (e) {
			me.player.openNext("{node5}","");
		}
		this._menuitem_3.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_3);
		this._menuitem_2=document.createElement('div');
		this._menuitem_2__text=document.createElement('div');
		this._menuitem_2.className='ggskin ggskin_textdiv';
		this._menuitem_2.ggTextDiv=this._menuitem_2__text;
		this._menuitem_2.ggId="MenuItem_2";
		this._menuitem_2.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_2.ggVisible=true;
		this._menuitem_2.className='ggskin ggskin_text ';
		this._menuitem_2.ggType='text';
		hs ='';
		hs+='height : 25px;';
		hs+='left : 88px;';
		hs+='position : absolute;';
		...
		hs+='width : 151px;';
		hs+='pointer-events:auto;';
		this._menuitem_2.setAttribute('style',hs);
		this._menuitem_2.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_2.style[domTransform]=parameterToTransform(this._menuitem_2.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_2__text.setAttribute('style',hs);
		this._menuitem_2__text.innerHTML="Living Room";
		this._menuitem_2.appendChild(this._menuitem_2__text);
		me._menuitem_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_2.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_2.onclick=function (e) {
			me.player.openNext("{node3}","");
			me.player.setPanTiltFov(-153.74,-8.15,74);
		}
		this._menuitem_2.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_2);
		this._menuitem_1=document.createElement('div');
		this._menuitem_1__text=document.createElement('div');
		this._menuitem_1.className='ggskin ggskin_textdiv';
		this._menuitem_1.ggTextDiv=this._menuitem_1__text;
		this._menuitem_1.ggId="MenuItem_1";
		this._menuitem_1.ggParameter={ rx:0,ry:0,a:0,sx:1.4,sy:1.4 };
		this._menuitem_1.ggVisible=true;
		this._menuitem_1.className='ggskin ggskin_text ';
		this._menuitem_1.ggType='text';
		hs ='';
		hs+='height : 25px;';
		hs+='left : 89px;';
		hs+='position : absolute;';
		...
		hs+='width : 151px;';
		hs+='pointer-events:auto;';
		this._menuitem_1.setAttribute('style',hs);
		this._menuitem_1.style[domTransform + 'Origin']='50% 50%';
		this._menuitem_1.style[domTransform]=parameterToTransform(this._menuitem_1.ggParameter);
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._menuitem_1__text.setAttribute('style',hs);
		this._menuitem_1__text.innerHTML="Entrance";
		this._menuitem_1.appendChild(this._menuitem_1__text);
		me._menuitem_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._menuitem_1.onclick=function (e) {
			me.player.openNext("{node3}","");
		}
		this._menuitem_1.ggUpdatePosition=function (useTransition) {
		}
		this._svg_1.appendChild(this._menuitem_1);
		this._menuitem_1_underline=document.createElement('div');
		this._menuitem_1_underline.ggId="MenuItem_1_underline";
		this._menuitem_1_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_1_underline.ggVisible=false;
		this._menuitem_1_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_1_underline.ggType='rectangle';
		hs ='';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_1_underline.setAttribute('style',hs);
		this._menuitem_1_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_1_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_1_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_1_underline.ggCurrentLogicStateVisible = -1;
		me._menuitem_1_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_1_underline.ggUpdateConditionTimer=function () {
			var newLogicStateAlpha;
			if (
				(me.player.getPanN() > -100) &&
				(me.player.getPanN() < 165)
			)
			{
			...
			if (me._menuitem_1_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_1_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_1_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_1_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_1_underline.style.visibility=me._menuitem_1_underline.ggVisible?'inherit':'hidden';
					me._menuitem_1_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_1_underline.style.visibility="hidden";
					me._menuitem_1_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_1_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateVisible;
			if (
			...
			if (me._menuitem_1_underline.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._menuitem_1_underline.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._menuitem_1_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_1_underline.ggCurrentLogicStateVisible == 0) {
					me._menuitem_1_underline.style.visibility=(Number(me._menuitem_1_underline.style.opacity)>0||!me._menuitem_1_underline.style.opacity)?'inherit':'hidden';
					me._menuitem_1_underline.ggVisible=true;
				}
				else {
					me._menuitem_1_underline.style.visibility="hidden";
					me._menuitem_1_underline.ggVisible=false;
				}
			}
		}
		this._menuitem_1_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_1_underline.ggNodeChange=function () {
			me._menuitem_1_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_1_underline);
		this._menuitem_2_underline=document.createElement('div');
		this._menuitem_2_underline.ggId="MenuItem_2_underline";
		this._menuitem_2_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_2_underline.ggVisible=false;
		this._menuitem_2_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_2_underline.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'border-radius : 7px;';
		hs+='border-radius : 7px;';
		hs+='background : #ffffff;';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_2_underline.setAttribute('style',hs);
		this._menuitem_2_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_2_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_2_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_2_underline.ggCurrentLogicStateVisible = -1;
		me._menuitem_2_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_2_underline.ggUpdateConditionTimer=function () {
			var newLogicStateAlpha;
			if (
				(me.player.getPanN() < -100) ||
				(me.player.getPanN() > 165)
			...
			if (me._menuitem_2_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_2_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_2_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_2_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_2_underline.style.visibility=me._menuitem_2_underline.ggVisible?'inherit':'hidden';
					me._menuitem_2_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_2_underline.style.visibility="hidden";
					me._menuitem_2_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_2_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateVisible;
			if (
				(me.ggUserdata.tags.indexOf("1") != -1)
			)
			...
			if (me._menuitem_2_underline.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._menuitem_2_underline.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._menuitem_2_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_2_underline.ggCurrentLogicStateVisible == 0) {
					me._menuitem_2_underline.style.visibility=(Number(me._menuitem_2_underline.style.opacity)>0||!me._menuitem_2_underline.style.opacity)?'inherit':'hidden';
					me._menuitem_2_underline.ggVisible=true;
				}
				else {
					me._menuitem_2_underline.style.visibility="hidden";
					me._menuitem_2_underline.ggVisible=false;
				}
			}
		}
		this._menuitem_2_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_2_underline.ggNodeChange=function () {
			me._menuitem_2_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_2_underline);
		this._menuitem_3_underline=document.createElement('div');
		this._menuitem_3_underline.ggId="MenuItem_3_underline";
		this._menuitem_3_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_3_underline.ggVisible=false;
		this._menuitem_3_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_3_underline.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'border-radius : 7px;';
		hs+='border-radius : 7px;';
		hs+='background : #ffffff;';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_3_underline.setAttribute('style',hs);
		this._menuitem_3_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_3_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_3_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_3_underline.ggCurrentLogicStateVisible = -1;
		me._menuitem_3_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_3_underline.ggUpdateConditionTimer=function () {
			var newLogicStateAlpha;
			if (
				(me.ggUserdata.tags.indexOf("2") != -1) &&
				(me.player.getPanN() > 45) ||
				(me.player.getPanN() < -130)
			)
			{
				newLogicStateAlpha = 0;
			}
			...
			if (me._menuitem_3_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_3_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_3_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_3_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_3_underline.style.visibility=me._menuitem_3_underline.ggVisible?'inherit':'hidden';
					me._menuitem_3_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_3_underline.style.visibility="hidden";
					me._menuitem_3_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_3_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateVisible;
			if (
				(me.ggUserdata.tags.indexOf("2") != -1)
			)
			...
			if (me._menuitem_3_underline.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._menuitem_3_underline.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._menuitem_3_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_3_underline.ggCurrentLogicStateVisible == 0) {
					me._menuitem_3_underline.style.visibility=(Number(me._menuitem_3_underline.style.opacity)>0||!me._menuitem_3_underline.style.opacity)?'inherit':'hidden';
					me._menuitem_3_underline.ggVisible=true;
				}
				else {
					me._menuitem_3_underline.style.visibility="hidden";
					me._menuitem_3_underline.ggVisible=false;
				}
			}
		}
		this._menuitem_3_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_3_underline.ggNodeChange=function () {
			me._menuitem_3_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_3_underline);
		this._menuitem_4_underline=document.createElement('div');
		this._menuitem_4_underline.ggId="MenuItem_4_underline";
		this._menuitem_4_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_4_underline.ggVisible=false;
		this._menuitem_4_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_4_underline.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'border-radius : 7px;';
		hs+='border-radius : 7px;';
		hs+='background : #ffffff;';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_4_underline.setAttribute('style',hs);
		this._menuitem_4_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_4_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_4_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_4_underline.ggCurrentLogicStateVisible = -1;
		me._menuitem_4_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_4_underline.ggUpdateConditionTimer=function () {
			var newLogicStateAlpha;
			if (
				(me.player.getPanN() > -130) &&
				(me.player.getPanN() < 45)
			...
			if (me._menuitem_4_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_4_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_4_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_4_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_4_underline.style.visibility=me._menuitem_4_underline.ggVisible?'inherit':'hidden';
					me._menuitem_4_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_4_underline.style.visibility="hidden";
					me._menuitem_4_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_4_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateVisible;
			if (
				(me.ggUserdata.tags.indexOf("2") != -1)
			)
			...
			if (me._menuitem_4_underline.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._menuitem_4_underline.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._menuitem_4_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_4_underline.ggCurrentLogicStateVisible == 0) {
					me._menuitem_4_underline.style.visibility=(Number(me._menuitem_4_underline.style.opacity)>0||!me._menuitem_4_underline.style.opacity)?'inherit':'hidden';
					me._menuitem_4_underline.ggVisible=true;
				}
				else {
					me._menuitem_4_underline.style.visibility="hidden";
					me._menuitem_4_underline.ggVisible=false;
				}
			}
		}
		this._menuitem_4_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_4_underline.ggNodeChange=function () {
			me._menuitem_4_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_4_underline);
		this._menuitem_5_underline=document.createElement('div');
		this._menuitem_5_underline.ggId="MenuItem_5_underline";
		this._menuitem_5_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_5_underline.ggVisible=true;
		this._menuitem_5_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_5_underline.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'border-radius : 7px;';
		hs+='border-radius : 7px;';
		hs+='background : #ffffff;';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_5_underline.setAttribute('style',hs);
		this._menuitem_5_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_5_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_5_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_5_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_5_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateAlpha;
			if (
			...
			if (me._menuitem_5_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_5_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_5_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_5_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_5_underline.style.visibility=me._menuitem_5_underline.ggVisible?'inherit':'hidden';
					me._menuitem_5_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_5_underline.style.visibility="hidden";
					me._menuitem_5_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_5_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_5_underline.ggNodeChange=function () {
			me._menuitem_5_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_5_underline);
		this._menuitem_6_underline=document.createElement('div');
		this._menuitem_6_underline.ggId="MenuItem_6_underline";
		this._menuitem_6_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_6_underline.ggVisible=true;
		this._menuitem_6_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_6_underline.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'border-radius : 7px;';
		hs+='border-radius : 7px;';
		hs+='background : #ffffff;';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_6_underline.setAttribute('style',hs);
		this._menuitem_6_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_6_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_6_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_6_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_6_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateAlpha;
			if (
			...
			if (me._menuitem_6_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_6_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_6_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_6_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_6_underline.style.visibility=me._menuitem_6_underline.ggVisible?'inherit':'hidden';
					me._menuitem_6_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_6_underline.style.visibility="hidden";
					me._menuitem_6_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_6_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_6_underline.ggNodeChange=function () {
			me._menuitem_6_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_6_underline);
		this._menuitem_7_underline=document.createElement('div');
		this._menuitem_7_underline.ggId="MenuItem_7_underline";
		this._menuitem_7_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_7_underline.ggVisible=true;
		this._menuitem_7_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_7_underline.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'border-radius : 7px;';
		hs+='border-radius : 7px;';
		hs+='background : #ffffff;';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_7_underline.setAttribute('style',hs);
		this._menuitem_7_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_7_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_7_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_7_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_7_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateAlpha;
			if (
			...
			if (me._menuitem_7_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_7_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_7_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_7_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_7_underline.style.visibility=me._menuitem_7_underline.ggVisible?'inherit':'hidden';
					me._menuitem_7_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_7_underline.style.visibility="hidden";
					me._menuitem_7_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_7_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_7_underline.ggNodeChange=function () {
			me._menuitem_7_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_7_underline);
		this._menuitem_8_underline=document.createElement('div');
		this._menuitem_8_underline.ggId="MenuItem_8_underline";
		this._menuitem_8_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_8_underline.ggVisible=true;
		this._menuitem_8_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_8_underline.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'border-radius : 7px;';
		hs+='border-radius : 7px;';
		hs+='background : #ffffff;';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_8_underline.setAttribute('style',hs);
		this._menuitem_8_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_8_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_8_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_8_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_8_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateAlpha;
			if (
			...
			if (me._menuitem_8_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_8_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_8_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_8_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_8_underline.style.visibility=me._menuitem_8_underline.ggVisible?'inherit':'hidden';
					me._menuitem_8_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_8_underline.style.visibility="hidden";
					me._menuitem_8_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_8_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_8_underline.ggNodeChange=function () {
			me._menuitem_8_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_8_underline);
		this._menuitem_9_underline=document.createElement('div');
		this._menuitem_9_underline.ggId="MenuItem_9_underline";
		this._menuitem_9_underline.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._menuitem_9_underline.ggVisible=true;
		this._menuitem_9_underline.className='ggskin ggskin_rectangle ';
		this._menuitem_9_underline.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'border-radius : 7px;';
		hs+='border-radius : 7px;';
		hs+='background : #ffffff;';
		...
		hs+='width : 140px;';
		hs+='pointer-events:auto;';
		this._menuitem_9_underline.setAttribute('style',hs);
		this._menuitem_9_underline.style[domTransform + 'Origin']='50% 50%';
		me._menuitem_9_underline.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._menuitem_9_underline.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._menuitem_9_underline.ggCurrentLogicStateAlpha = -1;
		this._menuitem_9_underline.ggUpdateConditionNodeChange=function () {
			var newLogicStateAlpha;
			if (
			...
			if (me._menuitem_9_underline.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._menuitem_9_underline.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._menuitem_9_underline.style[domTransition]='opacity 250ms ease 0ms, visibility 250ms ease 0ms';
				if (me._menuitem_9_underline.ggCurrentLogicStateAlpha == 0) {
					me._menuitem_9_underline.style.visibility=me._menuitem_9_underline.ggVisible?'inherit':'hidden';
					me._menuitem_9_underline.style.opacity=0.1;
				}
				else {
					me._menuitem_9_underline.style.visibility="hidden";
					me._menuitem_9_underline.style.opacity=0;
				}
			}
		}
		this._menuitem_9_underline.ggUpdatePosition=function (useTransition) {
		}
		this._menuitem_9_underline.ggNodeChange=function () {
			me._menuitem_9_underline.ggUpdateConditionNodeChange();
		}
		this._svg_1.appendChild(this._menuitem_9_underline);
		this._menu_group.appendChild(this._svg_1);
		this.divSkin.appendChild(this._menu_group);
		me._popup_video_file.ggVideoSource = 'media/';
		me._popup_video_file.ggVideoNotLoaded = true;
	...
	this.changeActiveNode=function(id) {
		...
		me._menuitem_1_underline.ggNodeChange();
		me._menuitem_2_underline.ggNodeChange();
		me._menuitem_3_underline.ggNodeChange();
		me._menuitem_4_underline.ggNodeChange();
		me._menuitem_5_underline.ggNodeChange();
		me._menuitem_6_underline.ggNodeChange();
		me._menuitem_7_underline.ggNodeChange();
		me._menuitem_8_underline.ggNodeChange();
		me._menuitem_9_underline.ggNodeChange();
	...
	this.skinTimerEvent=function() {
		...
		me._description.ggUpdateText();
		me._copyright.ggUpdateText();
		me._menu_group.ggUpdateConditionTimer();
		me._menuitem_1_underline.ggUpdateConditionTimer();
		me._menuitem_2_underline.ggUpdateConditionTimer();
		me._menuitem_3_underline.ggUpdateConditionTimer();
		me._menuitem_4_underline.ggUpdateConditionTimer();
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='ht_node') {
			...
			this._hsimage_node.onmouseout=function (e) {
				me._hsimage_node.style[domTransition]='none';
				me._hsimage_node.ggParameter.sx=0.952381;me._hsimage_node.ggParameter.sy=0.952381;
				me._hsimage_node.style[domTransform]=parameterToTransform(me._hsimage_node.ggParameter);
				me.elementMouseOver['hsimage_node']=false;
			}
			this._hsimage_node.ontouchend=function (e) {
				me.elementMouseOver['hsimage_node']=false;
			}
			this._hsimage_node.ggUpdatePosition=function (useTransition) {
			}
			this._photo_daml_info0=document.createElement('div');
			this._photo_daml_info0__text=document.createElement('div');
			this._photo_daml_info0.className='ggskin ggskin_textdiv';
			this._photo_daml_info0.ggTextDiv=this._photo_daml_info0__text;
			this._photo_daml_info0.ggId="Photo_daml_info";
			this._photo_daml_info0.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_daml_info0.ggVisible=false;
			this._photo_daml_info0.className='ggskin ggskin_text ';
			this._photo_daml_info0.ggType='text';
			hs ='';
			hs+='z-index: 100;';
			hs+='height : 17px;';
			hs+='left : -23px;';
			...
			hs+='width : 95px;';
			hs+='pointer-events:auto;';
			this._photo_daml_info0.setAttribute('style',hs);
			this._photo_daml_info0.style[domTransform + 'Origin']='50% 50%';
			hs ='position:absolute;';
			hs+='cursor: default;';
			hs+='left: 0px;';
			hs+='top:  0px;';
			...
			hs+='overflow: hidden;';
			this._photo_daml_info0__text.setAttribute('style',hs);
			this._photo_daml_info0.ggUpdateText=function() {
			...
			me._photo_daml_info0.ggUpdateText();
			this._photo_daml_info0.appendChild(this._photo_daml_info0__text);
			me._photo_daml_info0.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_daml_info0.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._photo_daml_info0.ggCurrentLogicStateVisible = -1;
			this._photo_daml_info0.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(me.elementMouseOver['hsimage_node'] == true)
				)
				...
				if (me._photo_daml_info0.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._photo_daml_info0.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._photo_daml_info0.style[domTransition]='';
					if (me._photo_daml_info0.ggCurrentLogicStateVisible == 0) {
						me._photo_daml_info0.style.visibility=(Number(me._photo_daml_info0.style.opacity)>0||!me._photo_daml_info0.style.opacity)?'inherit':'hidden';
						me._photo_daml_info0.ggVisible=true;
					}
					else {
						me._photo_daml_info0.style.visibility="hidden";
						me._photo_daml_info0.ggVisible=false;
					}
				}
			}
			this._photo_daml_info0.ggUpdatePosition=function (useTransition) {
				this.style[domTransition]='none';
				this.ggTextDiv.style.left=((99-this.ggTextDiv.offsetWidth)/2) + 'px';
			}
			this._hsimage_node.appendChild(this._photo_daml_info0);
			...
			this._preview_nodeimage__img.setAttribute('src',basePath + "images/preview_nodeimage_right_" + nodeId + ".png");
			...
			this.hotspotTimerEvent=function() {
				...
				if (me.elementMouseOver['hsimage_node']) {
					me._hsimage_node.style[domTransition]='none';
					me._hsimage_node.ggParameter.sx=1.05;me._hsimage_node.ggParameter.sy=1.05;
					me._hsimage_node.style[domTransform]=parameterToTransform(me._hsimage_node.ggParameter);
				}
				me._photo_daml_info0.ggUpdateText();
				me._photo_daml_info0.ggUpdateConditionTimer();
		...
		if (hotspot.skinid=='ht_node_left') {
			...
			this._hsimage_node_left=document.createElement('div');
			this._hsimage_node_left__img=document.createElement('img');
			this._hsimage_node_left__img.className='ggskin ggskin_svg';
			this._hsimage_node_left__img.setAttribute('src',basePath + 'images/hsimage_node_left.svg');
			this._hsimage_node_left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._hsimage_node_left__img['ondragstart']=function() { return false; };
			this._hsimage_node_left.appendChild(this._hsimage_node_left__img);
			this._hsimage_node_left.ggId="hsimage_node_left";
			this._hsimage_node_left.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._hsimage_node_left.ggVisible=true;
			this._hsimage_node_left.className='ggskin ggskin_svg ';
			this._hsimage_node_left.ggType='svg';
			hs ='';
			hs+='cursor : pointer;';
			hs+='height : 51px;';
			hs+='left : -25px;';
			...
			hs+='width : 51px;';
			hs+='pointer-events:auto;';
			this._hsimage_node_left.setAttribute('style',hs);
			this._hsimage_node_left.style[domTransform + 'Origin']='50% 50%';
			me._hsimage_node_left.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._hsimage_node_left.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._hsimage_node_left.onmouseover=function (e) {
				me.elementMouseOver['hsimage_node_left']=true;
			}
			this._hsimage_node_left.onmouseout=function (e) {
				me._hsimage_node_left.style[domTransition]='none';
				me._hsimage_node_left.ggParameter.sx=0.952381;me._hsimage_node_left.ggParameter.sy=0.952381;
				me._hsimage_node_left.style[domTransform]=parameterToTransform(me._hsimage_node_left.ggParameter);
				me.elementMouseOver['hsimage_node_left']=false;
			}
			this._hsimage_node_left.ontouchend=function (e) {
				me.elementMouseOver['hsimage_node_left']=false;
			}
			this._hsimage_node_left.ggUpdatePosition=function (useTransition) {
			}
			this._photo_daml_info_left=document.createElement('div');
			this._photo_daml_info_left__text=document.createElement('div');
			this._photo_daml_info_left.className='ggskin ggskin_textdiv';
			this._photo_daml_info_left.ggTextDiv=this._photo_daml_info_left__text;
			this._photo_daml_info_left.ggId="Photo_daml_info_left";
			this._photo_daml_info_left.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_daml_info_left.ggVisible=false;
			this._photo_daml_info_left.className='ggskin ggskin_text ';
			this._photo_daml_info_left.ggType='text';
			hs ='';
			hs+='z-index: 100;';
			hs+='height : 17px;';
			hs+='left : -23px;';
			...
			hs+='width : 95px;';
			hs+='pointer-events:auto;';
			this._photo_daml_info_left.setAttribute('style',hs);
			this._photo_daml_info_left.style[domTransform + 'Origin']='50% 50%';
			hs ='position:absolute;';
			hs+='cursor: default;';
			hs+='left: 0px;';
			hs+='top:  0px;';
			...
			hs+='padding: 3px 6px 3px 6px;';
			hs+='overflow: hidden;';
			this._photo_daml_info_left__text.setAttribute('style',hs);
			this._photo_daml_info_left__text.innerHTML=me.hotspot.title;
			this._photo_daml_info_left.appendChild(this._photo_daml_info_left__text);
			me._photo_daml_info_left.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_daml_info_left.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._photo_daml_info_left.ggCurrentLogicStateVisible = -1;
			this._photo_daml_info_left.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(me.elementMouseOver['hsimage_node_left'] == true)
				)
				...
				if (me._photo_daml_info_left.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._photo_daml_info_left.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._photo_daml_info_left.style[domTransition]='';
					if (me._photo_daml_info_left.ggCurrentLogicStateVisible == 0) {
						me._photo_daml_info_left.style.visibility=(Number(me._photo_daml_info_left.style.opacity)>0||!me._photo_daml_info_left.style.opacity)?'inherit':'hidden';
						me._photo_daml_info_left.ggVisible=true;
					}
					else {
						me._photo_daml_info_left.style.visibility="hidden";
						me._photo_daml_info_left.ggVisible=false;
					}
				}
			}
			this._photo_daml_info_left.ggUpdatePosition=function (useTransition) {
				this.style[domTransition]='none';
				this.ggTextDiv.style.left=((99-this.ggTextDiv.offsetWidth)/2) + 'px';
			}
			this._hsimage_node_left.appendChild(this._photo_daml_info_left);
			this.__div.appendChild(this._hsimage_node_left);
			this._hotspot_preview_left=document.createElement('div');
			this._hotspot_preview_left.ggId="hotspot_preview_left";
			this._hotspot_preview_left.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._hotspot_preview_left.ggVisible=false;
			this._hotspot_preview_left.className='ggskin ggskin_container ';
			this._hotspot_preview_left.ggType='container';
			hs ='';
			hs+='z-index: 100;';
			hs+='height : 75px;';
			hs+='left : -52px;';
			...
			hs+='width : 109px;';
			hs+='pointer-events:none;';
			this._hotspot_preview_left.setAttribute('style',hs);
			this._hotspot_preview_left.style[domTransform + 'Origin']='50% 50%';
			me._hotspot_preview_left.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._hotspot_preview_left.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._hotspot_preview_left.ggCurrentLogicStateVisible = -1;
			this._hotspot_preview_left.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(me.elementMouseOver['_div'] == true)
				)
				...
				if (me._hotspot_preview_left.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._hotspot_preview_left.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._hotspot_preview_left.style[domTransition]='';
					if (me._hotspot_preview_left.ggCurrentLogicStateVisible == 0) {
						me._hotspot_preview_left.style.visibility=(Number(me._hotspot_preview_left.style.opacity)>0||!me._hotspot_preview_left.style.opacity)?'inherit':'hidden';
						me._hotspot_preview_left.ggVisible=true;
					}
					else {
						me._hotspot_preview_left.style.visibility="hidden";
						me._hotspot_preview_left.ggVisible=false;
					}
				}
			}
			this._hotspot_preview_left.ggUpdatePosition=function (useTransition) {
			}
			this._preview_nodeimage_left=document.createElement('div');
			this._preview_nodeimage_left__img=document.createElement('img');
			this._preview_nodeimage_left__img.className='ggskin ggskin_nodeimage';
			this._preview_nodeimage_left__img.setAttribute('src',basePath + "images/preview_nodeimage_right_" + nodeId + ".png");
			this._preview_nodeimage_left.ggNodeId=nodeId;
			this._preview_nodeimage_left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._preview_nodeimage_left__img.className='ggskin ggskin_nodeimage';
			this._preview_nodeimage_left__img['ondragstart']=function() { return false; };
			this._preview_nodeimage_left.appendChild(this._preview_nodeimage_left__img);
			this._preview_nodeimage_left.ggId="Preview NodeImage_left";
			this._preview_nodeimage_left.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._preview_nodeimage_left.ggVisible=true;
			this._preview_nodeimage_left.className='ggskin ggskin_nodeimage ';
			this._preview_nodeimage_left.ggType='nodeimage';
			hs ='';
			hs+='height : 69px;';
			hs+='left : -7px;';
			hs+='position : absolute;';
			...
			hs+='width : 117px;';
			hs+='pointer-events:auto;';
			this._preview_nodeimage_left.setAttribute('style',hs);
			this._preview_nodeimage_left.style[domTransform + 'Origin']='50% 50%';
			me._preview_nodeimage_left.ggIsActive=function() {
				return me.player.getCurrentNode()==this.ggElementNodeId();
			}
			me._preview_nodeimage_left.ggElementNodeId=function() {
				return this.ggNodeId;
			}
			this._preview_nodeimage_left.ggUpdatePosition=function (useTransition) {
			}
			this._hotspot_preview_left.appendChild(this._preview_nodeimage_left);
			this._checkmark_tick_left=document.createElement('div');
			this._checkmark_tick_left__img=document.createElement('img');
			this._checkmark_tick_left__img.className='ggskin ggskin_svg';
			this._checkmark_tick_left__img.setAttribute('src',basePath + 'images/checkmark_tick_left.svg');
			this._checkmark_tick_left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._checkmark_tick_left__img['ondragstart']=function() { return false; };
			this._checkmark_tick_left.appendChild(this._checkmark_tick_left__img);
			this._checkmark_tick_left.ggId="checkmark_tick_left";
			this._checkmark_tick_left.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._checkmark_tick_left.ggVisible=false;
			this._checkmark_tick_left.className='ggskin ggskin_svg ';
			this._checkmark_tick_left.ggType='svg';
			hs ='';
			hs+='height : 20px;';
			hs+='left : 89px;';
			hs+='position : absolute;';
			...
			hs+='width : 22px;';
			hs+='pointer-events:auto;';
			this._checkmark_tick_left.setAttribute('style',hs);
			this._checkmark_tick_left.style[domTransform + 'Origin']='50% 50%';
			me._checkmark_tick_left.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._checkmark_tick_left.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._checkmark_tick_left.ggCurrentLogicStateVisible = -1;
			this._checkmark_tick_left.ggUpdateConditionNodeChange=function () {
				var newLogicStateVisible;
				if (
					(me.player.nodeVisited(me._checkmark_tick_left.ggElementNodeId()) == true)
				)
				{
					newLogicStateVisible = 0;
				}
				...
				if (me._checkmark_tick_left.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._checkmark_tick_left.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._checkmark_tick_left.style[domTransition]='';
					if (me._checkmark_tick_left.ggCurrentLogicStateVisible == 0) {
						me._checkmark_tick_left.style.visibility=(Number(me._checkmark_tick_left.style.opacity)>0||!me._checkmark_tick_left.style.opacity)?'inherit':'hidden';
						me._checkmark_tick_left.ggVisible=true;
					}
					else {
						me._checkmark_tick_left.style.visibility="hidden";
						me._checkmark_tick_left.ggVisible=false;
					}
				}
			}
			this._checkmark_tick_left.ggUpdatePosition=function (useTransition) {
			}
			this._checkmark_tick_left.ggNodeChange=function () {
				me._checkmark_tick_left.ggUpdateConditionNodeChange();
			}
			this._hotspot_preview_left.appendChild(this._checkmark_tick_left);
			this.__div.appendChild(this._hotspot_preview_left);
			this.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				if (me.elementMouseOver['_div']) {
				}
				if (me.elementMouseOver['hsimage_node_left']) {
					me._hsimage_node_left.style[domTransition]='none';
					me._hsimage_node_left.ggParameter.sx=1.05;me._hsimage_node_left.ggParameter.sy=1.05;
					me._hsimage_node_left.style[domTransform]=parameterToTransform(me._hsimage_node_left.ggParameter);
				}
				me._photo_daml_info_left.ggUpdateConditionTimer();
				me._hotspot_preview_left.ggUpdateConditionTimer();
			}
			this.hotspotTimerEvent();
		} else
		if (hotspot.skinid=='ht_node_right') {
			this.__div=document.createElement('div');
			this.__div.ggId="ht_node_right";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot ';
			this.__div.ggType='hotspot';
			...
			this._hsimage_node_right=document.createElement('div');
			this._hsimage_node_right__img=document.createElement('img');
			this._hsimage_node_right__img.className='ggskin ggskin_svg';
			this._hsimage_node_right__img.setAttribute('src',basePath + 'images/hsimage_node_right.svg');
			this._hsimage_node_right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._hsimage_node_right__img['ondragstart']=function() { return false; };
			this._hsimage_node_right.appendChild(this._hsimage_node_right__img);
			this._hsimage_node_right.ggId="hsimage_node_right";
			this._hsimage_node_right.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._hsimage_node_right.ggVisible=true;
			this._hsimage_node_right.className='ggskin ggskin_svg ';
			this._hsimage_node_right.ggType='svg';
			hs ='';
			hs+='cursor : pointer;';
			hs+='height : 51px;';
			hs+='left : -25px;';
			...
			hs+='width : 51px;';
			hs+='pointer-events:auto;';
			this._hsimage_node_right.setAttribute('style',hs);
			this._hsimage_node_right.style[domTransform + 'Origin']='50% 50%';
			me._hsimage_node_right.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._hsimage_node_right.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._hsimage_node_right.onmouseover=function (e) {
				me.elementMouseOver['hsimage_node_right']=true;
			}
			this._hsimage_node_right.onmouseout=function (e) {
				me._hsimage_node_right.style[domTransition]='none';
				me._hsimage_node_right.ggParameter.sx=0.952381;me._hsimage_node_right.ggParameter.sy=0.952381;
				me._hsimage_node_right.style[domTransform]=parameterToTransform(me._hsimage_node_right.ggParameter);
				me.elementMouseOver['hsimage_node_right']=false;
			}
			this._hsimage_node_right.ontouchend=function (e) {
				me.elementMouseOver['hsimage_node_right']=false;
			}
			this._hsimage_node_right.ggUpdatePosition=function (useTransition) {
			}
			this._photo_daml_info_right=document.createElement('div');
			this._photo_daml_info_right__text=document.createElement('div');
			this._photo_daml_info_right.className='ggskin ggskin_textdiv';
			this._photo_daml_info_right.ggTextDiv=this._photo_daml_info_right__text;
			this._photo_daml_info_right.ggId="Photo_daml_info_right";
			this._photo_daml_info_right.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_daml_info_right.ggVisible=false;
			this._photo_daml_info_right.className='ggskin ggskin_text ';
			this._photo_daml_info_right.ggType='text';
			hs ='';
			hs+='z-index: 100;';
			hs+='height : 17px;';
			hs+='left : -23px;';
			...
			hs+='width : 95px;';
			hs+='pointer-events:auto;';
			this._photo_daml_info_right.setAttribute('style',hs);
			this._photo_daml_info_right.style[domTransform + 'Origin']='50% 50%';
			hs ='position:absolute;';
			hs+='cursor: default;';
			hs+='left: 0px;';
			hs+='top:  0px;';
			...
			hs+='padding: 3px 6px 3px 6px;';
			hs+='overflow: hidden;';
			this._photo_daml_info_right__text.setAttribute('style',hs);
			this._photo_daml_info_right__text.innerHTML=me.hotspot.title;
			this._photo_daml_info_right.appendChild(this._photo_daml_info_right__text);
			me._photo_daml_info_right.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_daml_info_right.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._photo_daml_info_right.ggCurrentLogicStateVisible = -1;
			this._photo_daml_info_right.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(me.elementMouseOver['hsimage_node_right'] == true)
				)
				...
				if (me._photo_daml_info_right.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._photo_daml_info_right.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._photo_daml_info_right.style[domTransition]='';
					if (me._photo_daml_info_right.ggCurrentLogicStateVisible == 0) {
						me._photo_daml_info_right.style.visibility=(Number(me._photo_daml_info_right.style.opacity)>0||!me._photo_daml_info_right.style.opacity)?'inherit':'hidden';
						me._photo_daml_info_right.ggVisible=true;
					}
					else {
						me._photo_daml_info_right.style.visibility="hidden";
						me._photo_daml_info_right.ggVisible=false;
					}
				}
			}
			this._photo_daml_info_right.ggUpdatePosition=function (useTransition) {
				this.style[domTransition]='none';
				this.ggTextDiv.style.left=((99-this.ggTextDiv.offsetWidth)/2) + 'px';
			}
			this._hsimage_node_right.appendChild(this._photo_daml_info_right);
			this.__div.appendChild(this._hsimage_node_right);
			this._hotspot_preview_right=document.createElement('div');
			this._hotspot_preview_right.ggId="hotspot_preview_right";
			this._hotspot_preview_right.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._hotspot_preview_right.ggVisible=false;
			this._hotspot_preview_right.className='ggskin ggskin_container ';
			this._hotspot_preview_right.ggType='container';
			hs ='';
			hs+='z-index: 100;';
			hs+='height : 75px;';
			hs+='left : -52px;';
			...
			hs+='width : 109px;';
			hs+='pointer-events:none;';
			this._hotspot_preview_right.setAttribute('style',hs);
			this._hotspot_preview_right.style[domTransform + 'Origin']='50% 50%';
			me._hotspot_preview_right.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._hotspot_preview_right.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._hotspot_preview_right.ggCurrentLogicStateVisible = -1;
			this._hotspot_preview_right.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(me.elementMouseOver['_div'] == true)
				)
				...
				if (me._hotspot_preview_right.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._hotspot_preview_right.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._hotspot_preview_right.style[domTransition]='';
					if (me._hotspot_preview_right.ggCurrentLogicStateVisible == 0) {
						me._hotspot_preview_right.style.visibility=(Number(me._hotspot_preview_right.style.opacity)>0||!me._hotspot_preview_right.style.opacity)?'inherit':'hidden';
						me._hotspot_preview_right.ggVisible=true;
					}
					else {
						me._hotspot_preview_right.style.visibility="hidden";
						me._hotspot_preview_right.ggVisible=false;
					}
				}
			}
			this._hotspot_preview_right.ggUpdatePosition=function (useTransition) {
			}
			this._preview_nodeimage_right=document.createElement('div');
			this._preview_nodeimage_right__img=document.createElement('img');
			this._preview_nodeimage_right__img.className='ggskin ggskin_nodeimage';
			this._preview_nodeimage_right__img.setAttribute('src',basePath + "images/preview_nodeimage_right_" + nodeId + ".png");
			this._preview_nodeimage_right.ggNodeId=nodeId;
			this._preview_nodeimage_right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._preview_nodeimage_right__img.className='ggskin ggskin_nodeimage';
			this._preview_nodeimage_right__img['ondragstart']=function() { return false; };
			this._preview_nodeimage_right.appendChild(this._preview_nodeimage_right__img);
			this._preview_nodeimage_right.ggId="Preview NodeImage_right";
			this._preview_nodeimage_right.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._preview_nodeimage_right.ggVisible=true;
			this._preview_nodeimage_right.className='ggskin ggskin_nodeimage ';
			this._preview_nodeimage_right.ggType='nodeimage';
			hs ='';
			hs+='height : 69px;';
			hs+='left : -7px;';
			hs+='position : absolute;';
			...
			hs+='width : 117px;';
			hs+='pointer-events:auto;';
			this._preview_nodeimage_right.setAttribute('style',hs);
			this._preview_nodeimage_right.style[domTransform + 'Origin']='50% 50%';
			me._preview_nodeimage_right.ggIsActive=function() {
				return me.player.getCurrentNode()==this.ggElementNodeId();
			}
			me._preview_nodeimage_right.ggElementNodeId=function() {
				return this.ggNodeId;
			}
			this._preview_nodeimage_right.ggUpdatePosition=function (useTransition) {
			}
			this._hotspot_preview_right.appendChild(this._preview_nodeimage_right);
			this._checkmark_tick_right=document.createElement('div');
			this._checkmark_tick_right__img=document.createElement('img');
			this._checkmark_tick_right__img.className='ggskin ggskin_svg';
			this._checkmark_tick_right__img.setAttribute('src',basePath + 'images/checkmark_tick_right.svg');
			this._checkmark_tick_right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._checkmark_tick_right__img['ondragstart']=function() { return false; };
			this._checkmark_tick_right.appendChild(this._checkmark_tick_right__img);
			this._checkmark_tick_right.ggId="checkmark_tick_right";
			this._checkmark_tick_right.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._checkmark_tick_right.ggVisible=false;
			this._checkmark_tick_right.className='ggskin ggskin_svg ';
			this._checkmark_tick_right.ggType='svg';
			hs ='';
			hs+='height : 20px;';
			hs+='left : 89px;';
			hs+='position : absolute;';
			...
			hs+='width : 22px;';
			hs+='pointer-events:auto;';
			this._checkmark_tick_right.setAttribute('style',hs);
			this._checkmark_tick_right.style[domTransform + 'Origin']='50% 50%';
			me._checkmark_tick_right.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._checkmark_tick_right.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._checkmark_tick_right.ggCurrentLogicStateVisible = -1;
			this._checkmark_tick_right.ggUpdateConditionNodeChange=function () {
				var newLogicStateVisible;
				if (
					(me.player.nodeVisited(me._checkmark_tick_right.ggElementNodeId()) == true)
				)
				{
					newLogicStateVisible = 0;
				}
				...
				if (me._checkmark_tick_right.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._checkmark_tick_right.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._checkmark_tick_right.style[domTransition]='';
					if (me._checkmark_tick_right.ggCurrentLogicStateVisible == 0) {
						me._checkmark_tick_right.style.visibility=(Number(me._checkmark_tick_right.style.opacity)>0||!me._checkmark_tick_right.style.opacity)?'inherit':'hidden';
						me._checkmark_tick_right.ggVisible=true;
					}
					else {
						me._checkmark_tick_right.style.visibility="hidden";
						me._checkmark_tick_right.ggVisible=false;
					}
				}
			}
			this._checkmark_tick_right.ggUpdatePosition=function (useTransition) {
			}
			this._checkmark_tick_right.ggNodeChange=function () {
				me._checkmark_tick_right.ggUpdateConditionNodeChange();
			}
			this._hotspot_preview_right.appendChild(this._checkmark_tick_right);
			this.__div.appendChild(this._hotspot_preview_right);
			this.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				if (me.elementMouseOver['_div']) {
				}
				if (me.elementMouseOver['hsimage_node_right']) {
					me._hsimage_node_right.style[domTransition]='none';
					me._hsimage_node_right.ggParameter.sx=1.05;me._hsimage_node_right.ggParameter.sy=1.05;
					me._hsimage_node_right.style[domTransform]=parameterToTransform(me._hsimage_node_right.ggParameter);
				}
				me._photo_daml_info_right.ggUpdateConditionTimer();
				me._hotspot_preview_right.ggUpdateConditionTimer();
			}
			this.hotspotTimerEvent();
		} else
		if (hotspot.skinid=='Photo_baseball_1') {
			this.__div=document.createElement('div');
			this.__div.ggId="Photo_baseball_1";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot ';
			this.__div.ggType='hotspot';
			...
			this._photo_baseball_rollover=document.createElement('div');
			this._photo_baseball_rollover__img=document.createElement('img');
			this._photo_baseball_rollover__img.className='ggskin ggskin_svg';
			this._photo_baseball_rollover__img.setAttribute('src',basePath + 'images/photo_baseball_rollover.svg');
			this._photo_baseball_rollover__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._photo_baseball_rollover__img['ondragstart']=function() { return false; };
			this._photo_baseball_rollover.appendChild(this._photo_baseball_rollover__img);
			this._photo_baseball_rollover.ggId="photo_baseball_rollover";
			this._photo_baseball_rollover.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_baseball_rollover.ggVisible=true;
			this._photo_baseball_rollover.className='ggskin ggskin_svg ';
			this._photo_baseball_rollover.ggType='svg';
			hs ='';
			hs+='height : 132px;';
			hs+='left : -57px;';
			hs+='opacity : 0;';
			...
			hs+='width : 119px;';
			hs+='pointer-events:auto;';
			this._photo_baseball_rollover.setAttribute('style',hs);
			this._photo_baseball_rollover.style[domTransform + 'Origin']='50% 50%';
			me._photo_baseball_rollover.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_baseball_rollover.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._photo_baseball_rollover.ggUpdatePosition=function (useTransition) {
			}
			this.__div.appendChild(this._photo_baseball_rollover);
			this._photo_baseball_check=document.createElement('div');
			this._photo_baseball_check__img=document.createElement('img');
			this._photo_baseball_check__img.className='ggskin ggskin_svg';
			this._photo_baseball_check__img.setAttribute('src',basePath + 'images/photo_baseball_check.svg');
			this._photo_baseball_check__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._photo_baseball_check__img['ondragstart']=function() { return false; };
			this._photo_baseball_check.appendChild(this._photo_baseball_check__img);
			this._photo_baseball_check.ggId="photo_baseball_check";
			this._photo_baseball_check.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_baseball_check.ggVisible=false;
			this._photo_baseball_check.className='ggskin ggskin_svg ';
			this._photo_baseball_check.ggType='svg';
			hs ='';
			hs+='height : 20px;';
			hs+='left : 37px;';
			hs+='opacity : 0;';
			...
			hs+='width : 23px;';
			hs+='pointer-events:auto;';
			this._photo_baseball_check.setAttribute('style',hs);
			this._photo_baseball_check.style[domTransform + 'Origin']='50% 50%';
			me._photo_baseball_check.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_baseball_check.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._photo_baseball_check.ggCurrentLogicStateVisible = -1;
			this._photo_baseball_check.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(ggSkinVars['PhotoBaseballCheck'] == true)
				)
				{
					newLogicStateVisible = 0;
				}
				...
				if (me._photo_baseball_check.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._photo_baseball_check.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._photo_baseball_check.style[domTransition]='';
					if (me._photo_baseball_check.ggCurrentLogicStateVisible == 0) {
						me._photo_baseball_check.style.visibility=(Number(me._photo_baseball_check.style.opacity)>0||!me._photo_baseball_check.style.opacity)?'inherit':'hidden';
						me._photo_baseball_check.ggVisible=true;
					}
					else {
						me._photo_baseball_check.style.visibility="hidden";
						me._photo_baseball_check.ggVisible=false;
					}
				}
			}
			this._photo_baseball_check.ggUpdatePosition=function (useTransition) {
			}
			this.__div.appendChild(this._photo_baseball_check);
			this._photo_baseball_icon=document.createElement('div');
			this._photo_baseball_icon__img=document.createElement('img');
			this._photo_baseball_icon__img.className='ggskin ggskin_svg';
			this._photo_baseball_icon__img.setAttribute('src',basePath + 'images/photo_baseball_icon.svg');
			this._photo_baseball_icon__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._photo_baseball_icon__img['ondragstart']=function() { return false; };
			this._photo_baseball_icon.appendChild(this._photo_baseball_icon__img);
			this._photo_baseball_icon.ggId="photo_baseball_icon";
			this._photo_baseball_icon.ggParameter={ rx:0,ry:0,a:0,sx:0.9,sy:0.9 };
			this._photo_baseball_icon.ggVisible=true;
			this._photo_baseball_icon.className='ggskin ggskin_svg ';
			this._photo_baseball_icon.ggType='svg';
			hs ='';
			hs+='height : 55px;';
			hs+='left : -24px;';
			hs+='position : absolute;';
			...
			hs+='width : 55px;';
			hs+='pointer-events:auto;';
			this._photo_baseball_icon.setAttribute('style',hs);
			this._photo_baseball_icon.style[domTransform + 'Origin']='50% 50%';
			this._photo_baseball_icon.style[domTransform]=parameterToTransform(this._photo_baseball_icon.ggParameter);
			me._photo_baseball_icon.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_baseball_icon.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._photo_baseball_icon.onclick=function (e) {
				ggSkinVars['PhotoBaseballCheck'] = true;
			}
			this._photo_baseball_icon.onmouseover=function (e) {
				me.elementMouseOver['photo_baseball_icon']=true;
			}
			this._photo_baseball_icon.onmouseout=function (e) {
				me._photo_baseball_rollover.style[domTransition]='none';
				me._photo_baseball_rollover.style.opacity='0';
				me._photo_baseball_rollover.style.visibility='hidden';
				me._photo_baseball_check.style[domTransition]='none';
				me._photo_baseball_check.style.opacity='0';
				me._photo_baseball_check.style.visibility='hidden';
				me._photo_baseball_icon.style[domTransition]='none';
				me._photo_baseball_icon.ggParameter.sx=0.952381;me._photo_baseball_icon.ggParameter.sy=0.952381;
				me._photo_baseball_icon.style[domTransform]=parameterToTransform(me._photo_baseball_icon.ggParameter);
				me.elementMouseOver['photo_baseball_icon']=false;
			}
			this._photo_baseball_icon.ontouchend=function (e) {
				me.elementMouseOver['photo_baseball_icon']=false;
			}
			this._photo_baseball_icon.ggUpdatePosition=function (useTransition) {
			}
			this.__div.appendChild(this._photo_baseball_icon);
			this._photo_basball_info=document.createElement('div');
			this._photo_basball_info__text=document.createElement('div');
			this._photo_basball_info.className='ggskin ggskin_textdiv';
			this._photo_basball_info.ggTextDiv=this._photo_basball_info__text;
			this._photo_basball_info.ggId="Photo_basball_info";
			this._photo_basball_info.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_basball_info.ggVisible=false;
			this._photo_basball_info.className='ggskin ggskin_text ';
			this._photo_basball_info.ggType='text';
			hs ='';
			hs+='z-index: 100;';
			hs+='height : 17px;';
			hs+='left : -46px;';
			...
			hs+='width : 95px;';
			hs+='pointer-events:auto;';
			this._photo_basball_info.setAttribute('style',hs);
			this._photo_basball_info.style[domTransform + 'Origin']='50% 50%';
			hs ='position:absolute;';
			hs+='cursor: default;';
			hs+='left: 0px;';
			hs+='top:  0px;';
			...
			hs+='padding: 3px 6px 3px 6px;';
			hs+='overflow: hidden;';
			this._photo_basball_info__text.setAttribute('style',hs);
			this._photo_basball_info__text.innerHTML=me.hotspot.title;
			this._photo_basball_info.appendChild(this._photo_basball_info__text);
			me._photo_basball_info.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_basball_info.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._photo_basball_info.ggCurrentLogicStateVisible = -1;
			this._photo_basball_info.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(me.elementMouseOver['_div'] == true)
				)
				...
				if (me._photo_basball_info.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._photo_basball_info.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._photo_basball_info.style[domTransition]='';
					if (me._photo_basball_info.ggCurrentLogicStateVisible == 0) {
						me._photo_basball_info.style.visibility=(Number(me._photo_basball_info.style.opacity)>0||!me._photo_basball_info.style.opacity)?'inherit':'hidden';
						me._photo_basball_info.ggVisible=true;
					}
					else {
						me._photo_basball_info.style.visibility="hidden";
						me._photo_basball_info.ggVisible=false;
					}
				}
			}
			this._photo_basball_info.ggUpdatePosition=function (useTransition) {
				this.style[domTransition]='none';
				this.ggTextDiv.style.left=((99-this.ggTextDiv.offsetWidth)/2) + 'px';
			}
			this.__div.appendChild(this._photo_basball_info);
			this.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				if (me.elementMouseOver['_div']) {
				}
				me._photo_baseball_check.ggUpdateConditionTimer();
				if (me.elementMouseOver['photo_baseball_icon']) {
					me._photo_baseball_rollover.style[domTransition]='none';
					me._photo_baseball_rollover.style.opacity='1';
					me._photo_baseball_rollover.style.visibility=me._photo_baseball_rollover.ggVisible?'inherit':'hidden';
					me._photo_baseball_check.style[domTransition]='none';
					me._photo_baseball_check.style.opacity='1';
					me._photo_baseball_check.style.visibility=me._photo_baseball_check.ggVisible?'inherit':'hidden';
					me._photo_baseball_icon.style[domTransition]='none';
					me._photo_baseball_icon.ggParameter.sx=1.05;me._photo_baseball_icon.ggParameter.sy=1.05;
					me._photo_baseball_icon.style[domTransform]=parameterToTransform(me._photo_baseball_icon.ggParameter);
				}
				me._photo_basball_info.ggUpdateConditionTimer();
			}
			this.hotspotTimerEvent();
		} else
		...
		if (hotspot.skinid=='Photo_dam_1') {
			this.__div=document.createElement('div');
			this.__div.ggId="Photo_dam_1";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot ';
			this.__div.ggType='hotspot';
			...
			this._photo_dam_rollover=document.createElement('div');
			this._photo_dam_rollover__img=document.createElement('img');
			this._photo_dam_rollover__img.className='ggskin ggskin_svg';
			this._photo_dam_rollover__img.setAttribute('src',basePath + 'images/photo_dam_rollover.svg');
			this._photo_dam_rollover__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._photo_dam_rollover__img['ondragstart']=function() { return false; };
			this._photo_dam_rollover.appendChild(this._photo_dam_rollover__img);
			this._photo_dam_rollover.ggId="photo_dam_rollover";
			this._photo_dam_rollover.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_dam_rollover.ggVisible=true;
			this._photo_dam_rollover.className='ggskin ggskin_svg ';
			this._photo_dam_rollover.ggType='svg';
			hs ='';
			hs+='height : 132px;';
			hs+='left : -57px;';
			hs+='opacity : 0;';
			...
			hs+='width : 119px;';
			hs+='pointer-events:auto;';
			this._photo_dam_rollover.setAttribute('style',hs);
			this._photo_dam_rollover.style[domTransform + 'Origin']='50% 50%';
			me._photo_dam_rollover.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_dam_rollover.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._photo_dam_rollover.ggUpdatePosition=function (useTransition) {
			}
			this.__div.appendChild(this._photo_dam_rollover);
			this._photo_dam_check=document.createElement('div');
			this._photo_dam_check__img=document.createElement('img');
			this._photo_dam_check__img.className='ggskin ggskin_svg';
			this._photo_dam_check__img.setAttribute('src',basePath + 'images/photo_dam_check.svg');
			this._photo_dam_check__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._photo_dam_check__img['ondragstart']=function() { return false; };
			this._photo_dam_check.appendChild(this._photo_dam_check__img);
			this._photo_dam_check.ggId="photo_dam_check";
			this._photo_dam_check.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_dam_check.ggVisible=false;
			this._photo_dam_check.className='ggskin ggskin_svg ';
			this._photo_dam_check.ggType='svg';
			hs ='';
			hs+='height : 20px;';
			hs+='left : 37px;';
			hs+='opacity : 0;';
			...
			hs+='width : 23px;';
			hs+='pointer-events:auto;';
			this._photo_dam_check.setAttribute('style',hs);
			this._photo_dam_check.style[domTransform + 'Origin']='50% 50%';
			me._photo_dam_check.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_dam_check.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._photo_dam_check.ggCurrentLogicStateVisible = -1;
			this._photo_dam_check.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(ggSkinVars['PhotoDAMCheck'] == true)
				)
				{
					newLogicStateVisible = 0;
				}
				...
				if (me._photo_dam_check.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._photo_dam_check.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._photo_dam_check.style[domTransition]='';
					if (me._photo_dam_check.ggCurrentLogicStateVisible == 0) {
						me._photo_dam_check.style.visibility=(Number(me._photo_dam_check.style.opacity)>0||!me._photo_dam_check.style.opacity)?'inherit':'hidden';
						me._photo_dam_check.ggVisible=true;
					}
					else {
						me._photo_dam_check.style.visibility="hidden";
						me._photo_dam_check.ggVisible=false;
					}
				}
			}
			this._photo_dam_check.ggUpdatePosition=function (useTransition) {
			}
			this.__div.appendChild(this._photo_dam_check);
			this._photo_dam_icon=document.createElement('div');
			this._photo_dam_icon__img=document.createElement('img');
			this._photo_dam_icon__img.className='ggskin ggskin_svg';
			this._photo_dam_icon__img.setAttribute('src',basePath + 'images/photo_dam_icon.svg');
			this._photo_dam_icon__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._photo_dam_icon__img['ondragstart']=function() { return false; };
			this._photo_dam_icon.appendChild(this._photo_dam_icon__img);
			this._photo_dam_icon.ggId="photo_dam_icon";
			this._photo_dam_icon.ggParameter={ rx:0,ry:0,a:0,sx:0.9,sy:0.9 };
			this._photo_dam_icon.ggVisible=true;
			this._photo_dam_icon.className='ggskin ggskin_svg ';
			this._photo_dam_icon.ggType='svg';
			hs ='';
			hs+='height : 55px;';
			hs+='left : -24px;';
			hs+='position : absolute;';
			...
			hs+='width : 55px;';
			hs+='pointer-events:auto;';
			this._photo_dam_icon.setAttribute('style',hs);
			this._photo_dam_icon.style[domTransform + 'Origin']='50% 50%';
			this._photo_dam_icon.style[domTransform]=parameterToTransform(this._photo_dam_icon.ggParameter);
			me._photo_dam_icon.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_dam_icon.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._photo_dam_icon.onclick=function (e) {
				ggSkinVars['PhotoDAMCheck'] = true;
			}
			this._photo_dam_icon.onmouseover=function (e) {
				me.elementMouseOver['photo_dam_icon']=true;
			}
			this._photo_dam_icon.onmouseout=function (e) {
				me._photo_dam_rollover.style[domTransition]='none';
				me._photo_dam_rollover.style.opacity='0';
				me._photo_dam_rollover.style.visibility='hidden';
				me._photo_dam_check.style[domTransition]='none';
				me._photo_dam_check.style.opacity='0';
				me._photo_dam_check.style.visibility='hidden';
				me._photo_dam_icon.style[domTransition]='none';
				me._photo_dam_icon.ggParameter.sx=0.952381;me._photo_dam_icon.ggParameter.sy=0.952381;
				me._photo_dam_icon.style[domTransform]=parameterToTransform(me._photo_dam_icon.ggParameter);
				me.elementMouseOver['photo_dam_icon']=false;
			}
			this._photo_dam_icon.ontouchend=function (e) {
				me.elementMouseOver['photo_dam_icon']=false;
			}
			this._photo_dam_icon.ggUpdatePosition=function (useTransition) {
			}
			this.__div.appendChild(this._photo_dam_icon);
			this._photo_daml_info=document.createElement('div');
			this._photo_daml_info__text=document.createElement('div');
			this._photo_daml_info.className='ggskin ggskin_textdiv';
			this._photo_daml_info.ggTextDiv=this._photo_daml_info__text;
			this._photo_daml_info.ggId="Photo_daml_info";
			this._photo_daml_info.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._photo_daml_info.ggVisible=false;
			this._photo_daml_info.className='ggskin ggskin_text ';
			this._photo_daml_info.ggType='text';
			hs ='';
			hs+='z-index: 100;';
			hs+='height : 17px;';
			hs+='left : -47px;';
			...
			hs+='width : 95px;';
			hs+='pointer-events:auto;';
			this._photo_daml_info.setAttribute('style',hs);
			this._photo_daml_info.style[domTransform + 'Origin']='50% 50%';
			hs ='position:absolute;';
			hs+='cursor: default;';
			hs+='left: 0px;';
			hs+='top:  0px;';
			...
			hs+='padding: 3px 6px 3px 6px;';
			hs+='overflow: hidden;';
			this._photo_daml_info__text.setAttribute('style',hs);
			this._photo_daml_info__text.innerHTML=me.hotspot.title;
			this._photo_daml_info.appendChild(this._photo_daml_info__text);
			me._photo_daml_info.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._photo_daml_info.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._photo_daml_info.ggCurrentLogicStateVisible = -1;
			this._photo_daml_info.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(me.elementMouseOver['_div'] == true)
				)
				...
				if (me._photo_daml_info.ggCurrentLogicStateVisible != newLogicStateVisible) {
					me._photo_daml_info.ggCurrentLogicStateVisible = newLogicStateVisible;
					me._photo_daml_info.style[domTransition]='';
					if (me._photo_daml_info.ggCurrentLogicStateVisible == 0) {
						me._photo_daml_info.style.visibility=(Number(me._photo_daml_info.style.opacity)>0||!me._photo_daml_info.style.opacity)?'inherit':'hidden';
						me._photo_daml_info.ggVisible=true;
					}
					else {
						me._photo_daml_info.style.visibility="hidden";
						me._photo_daml_info.ggVisible=false;
					}
				}
			}
			this._photo_daml_info.ggUpdatePosition=function (useTransition) {
				this.style[domTransition]='none';
				this.ggTextDiv.style.left=((99-this.ggTextDiv.offsetWidth)/2) + 'px';
			}
			this.__div.appendChild(this._photo_daml_info);
			this.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				if (me.elementMouseOver['_div']) {
				}
				me._photo_dam_check.ggUpdateConditionTimer();
				if (me.elementMouseOver['photo_dam_icon']) {
					me._photo_dam_rollover.style[domTransition]='none';
					me._photo_dam_rollover.style.opacity='1';
					me._photo_dam_rollover.style.visibility=me._photo_dam_rollover.ggVisible?'inherit':'hidden';
					me._photo_dam_check.style[domTransition]='none';
					me._photo_dam_check.style.opacity='1';
					me._photo_dam_check.style.visibility=me._photo_dam_check.ggVisible?'inherit':'hidden';
					me._photo_dam_icon.style[domTransition]='none';
					me._photo_dam_icon.ggParameter.sx=1.05;me._photo_dam_icon.ggParameter.sy=1.05;
					me._photo_dam_icon.style[domTransform]=parameterToTransform(me._photo_dam_icon.ggParameter);
				}
				me._photo_daml_info.ggUpdateConditionTimer();
			}
			this.hotspotTimerEvent();
		} else
		{
